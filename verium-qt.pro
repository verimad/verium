...
#   Bracket the code to profile with ProfileStart("verium-qt.prof") and ProfileStop() and recompile
#   Run verium-qt through its paces then exit
#   Analyze with:
#      pprof ./verium-qt verium-qt.prof
#   For a graphical view you need to: sudo apt-get install graphviz gv
#   Then run:
#      pprof --gv ./verium-qt verium-qt.prof
PROFILE = 0
...
windows:QMAKE_LFLAGS *= -Wl,--dynamicbase -Wl,--nxcompat -Wl,--large-address-aware -static
...
macx:ICON = src/qt/res/icons/verium.icns
macx:TARGET = "Verium-Qt"
