#ifndef VERIBITCOINUNITS_H
#define VERIBITCOINUNITS_H
...
*/
class veriBitcoinUnits: public QAbstractListModel
{
public:
    explicit veriBitcoinUnits(QObject *parent);
...
typedef veriBitcoinUnits::Unit veriBitcoinUnit;
