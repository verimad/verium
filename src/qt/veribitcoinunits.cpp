...
veriBitcoinUnits::veriBitcoinUnits(QObject *parent):
...
bool veriBitcoinUnits::valid(int unit)
{
    switch(unit)
    {
    case VRC:
...
QString veriBitcoinUnits::name(int unit)
{
    switch(unit)
    {
...
QString veriBitcoinUnits::description(int unit)
{
    switch(unit)
    {
...
qint64 veriBitcoinUnits::factor(int unit)
{
    switch(unit)
    {
...
int veriBitcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
...
QString veriBitcoinUnits::format(int unit, qint64 n, bool fPlus, bool fHideAmounts)
{
    return formatMaxDecimals(unit, n, decimals(unit), fPlus, fHideAmounts);
}

QString veriBitcoinUnits::formatMaxDecimals(int unit, qint64 n, int decimals, bool fPlus, bool fHideAmounts)
{
...
QString veriBitcoinUnits::formatFee(int unit, qint64 n, bool fPlus)
{
    // Note: not using straight sprintf here because we do NOT want
    // localized number formatting.
    if(!valid(unit))
...
QString veriBitcoinUnits::formatWithUnit(int unit, qint64 amount, bool plussign, bool hideamounts)
{
...
QString veriBitcoinUnits::formatWithUnitWithMaxDecimals(int unit, qint64 amount, int decimals, bool plussign, bool hideamounts)
{
...
QString veriBitcoinUnits::formatWithUnitFee(int unit, qint64 amount, bool plussign)
{
    return formatFee(unit, amount, plussign) + QString(" ") + name(unit);
}

bool veriBitcoinUnits::parse(int unit, const QString &value, qint64 *val_out)
{
...
int veriBitcoinUnits::rowCount(const QModelIndex &parent) const
{
    Q_UNUSED(parent);
    return unitlist.size();
}

QVariant veriBitcoinUnits::data(const QModelIndex &index, int role) const
{
    int row = index.row();
